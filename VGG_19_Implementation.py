## Tensorflow Implementation of VGG 19 net
...
conv8=conv_layer(conv7, shape=[3, 3, 256, 256])
pool_3=max_pool(conv8)

#Block 4                                                                                #The shape is now 28x28x256

conv9=conv_layer(pool_3, shape=[3, 3, 256, 512])
conv10=conv_layer(conv9, shape=[3, 3, 512, 512])
conv11=conv_layer(conv10, shape=[3, 3, 512, 512])
conv12=conv_layer(conv11, shape=[3, 3, 512, 512])
pool_4=max_pool(conv12)

#Block 5                                                                                #The shape is now 14x14x512

conv13=conv_layer(pool_4, shape=[3, 3, 512, 512])
conv14=conv_layer(conv13, shape=[3, 3, 512, 512])
conv15=conv_layer(conv14, shape=[3, 3, 512, 512])
conv16=conv_layer(conv15, shape=[3, 3, 512, 512])
pool_5=max_pool(conv16)
